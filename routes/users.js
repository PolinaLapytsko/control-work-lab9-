...
router.post('/register', function(req, res){
	...
	req.checkBody('email', 'Введите пароль!').notEmpty();
	req.checkBody('email', 'Неверный e-mail').isEmail();
	...
	if(errors){
		...
		req.flash('success_msg', 'Регистрация успешна! Войдите используя свой логин и пароль');
